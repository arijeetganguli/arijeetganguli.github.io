...
const Portfolio = () => {
  ...
  useEffect(() => {
    sanari.portfolioHover();
    sanari.dataImage();
  });
  const { setPortfolioDetailsModal, modalToggle } = useContext(SanariContext);
  return (
    <SectionContainer name={"portfolio"}>
      <div className="container">
        <div className="sanari_tm_portfolio w-full h-auto clear-both float-left px-0 pt-[100px] pb-[40px]">
          <div className="sanari_tm_title w-full h-auto clear-both float-left mb-[62px]">
            ...
            <ul className="portfolio_list gallery_zoom ml-[-40px] list-none">
              <li className="vimeo mb-[40px] float-left w-1/3 pl-[40px] item__">
                <div className="inner w-full h-auto clear-both float-left overflow-hidden relative">
                  <div
                    className="entry sanari_tm_portfolio_animation_wrap"
