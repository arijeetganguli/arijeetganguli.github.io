const experiencesData = [
  {
    ...
    company: "Morningstar, Gurgaon",
  },
  {
    id: 2,
    date: "Aug 2015 - Oct 2019",
    designation: "Lead Software Engineer",
    company: "Square Yards, Gurgaon",
  },
  {
    id: 3,
    date: "May 2012 - May 2015",
    designation: "Software Developer",
    company: "Hi-Tech eSoft, Gurgaon",
  },
];
const educationData = [
  {
...
const EducationExperience = () => {
  return (
    <div className="sanari_tm_resumebox w-full h-auto clear-both float-left py-[93px] px-0">
      <div className="container">
        ...
        <div className="left w-1/2 pr-[50px]">
            ...
            <div className="sanari_tm_resume_list w-full h-auto clear-both float-left">
