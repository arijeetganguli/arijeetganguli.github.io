...
const socialIcon = [
  {
    ...
    link: "https://www.linkedin.com/in/arijeet-ganguli/",
  },
];
const Home = () => {
  return (
    <SectionContainer name={"home"}>
      <div className="container">
        <div className="sanari_tm_home w-full min-h-[100vh] clear-both flex items-center justify-center relative">
          <div className="home_content flex items-center">
            ...
            <div className="details ml-[80px]">
              <h3 className="name text-[55px] font-extrabold uppercase mb-[14px]">
                Arijeet <span>Ganguli</span>
              </h3>
              <p className="job font-montserrat font-medium max-w-[450px] mb-[25px]">
              Transforming data management with innovative tech solutions and strategic leadership.
              </p>
