...
const Mobile = () => {
  ...
  const { navChange, nav, menus } = useContext(SanariContext);
  return (
    <Fragment>
      <div className="sanari_tm_topbar bg-white fixed top-0 left-0 right-0 h-[50px] z-[14] hidden">
      ...
      <div
        className={`sanari_tm_mobile_menu fixed top-[50px] right-[-200px] h-[100vh] w-[200px] z-[15] bg-white transition-all duration-300 ${
          toggle ? "opened" : ""
        }`}
      >
